...
_register_viewset(views.AuthorizedLinkAccountViewSet)
_register_viewset(views.ConfiguredLinkAddonViewSet)
_register_viewset(views.ExternalLinkServiceViewSet)
_register_viewset(views.AuthorizedComputingAccountViewSet)
_register_viewset(views.ConfiguredComputingAddonViewSet)
_register_viewset(views.ExternalComputingServiceViewSet)
